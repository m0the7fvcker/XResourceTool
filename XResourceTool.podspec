#
# Be sure to run `pod lib lint XResourceTools.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'XResourceTool/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XResourceTool' => ['XResourceTools/Assets/*.png']
  # }

  s.public_header_files = 'XResourceTool/Classes/**/*.h'
